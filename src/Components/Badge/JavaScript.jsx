...
import Level1 from '../Assets/Badge/JavaScript/Noice JS.png';
import Level2 from '../Assets/Badge/JavaScript/Beginner JS.png';
import Level3 from '../Assets/Badge/JavaScript/Advanced JS.png';
import Level4 from '../Assets/Badge/JavaScript/Expert JS.png';
import Level5 from '../Assets/Badge/JavaScript/Master JS.png';
import Level6 from '../Assets/Badge/JavaScript/Legend JS.png';
...
const JavaScript = () => {
  ...
  return (
    <div className='gap-4 m-4'>
        <h1 className='mb-8 mr-8 text-3xl font-bold text-white font-roboto'>JavaScript Badges</h1>
