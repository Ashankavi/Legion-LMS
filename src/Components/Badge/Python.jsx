...
import Level1 from '../Assets/Badge/Python/Noice Python.png';
import Level2 from '../Assets/Badge/Python/Beginner Python.png';
import Level3 from '../Assets/Badge/Python/Advanced Python.png';
import Level4 from '../Assets/Badge/Python/Expert Python.png';
import Level5 from '../Assets/Badge/Python/Master Python.png';
import Level6 from '../Assets/Badge/Python/Legend Python.png';
...
const Python = () => {
  ...
  return (
    <div className='gap-4 m-4'>
        <h1 className='mb-8 mr-8 text-3xl font-bold text-white font-roboto'>Python Badges</h1>
